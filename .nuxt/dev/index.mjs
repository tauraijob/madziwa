...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, setHeader, getResponseStatusText } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/@vue/shared/dist/shared.cjs.js';
import { PrismaClient } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/@prisma/client/default.js';
import puppeteer from 'file://C:/Users/USER/Desktop/madziwa/node_modules/puppeteer/lib/esm/puppeteer/puppeteer.js';
import JSZip from 'file://C:/Users/USER/Desktop/madziwa/node_modules/jszip/lib/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/USER/Desktop/madziwa/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/USER/Desktop/madziwa/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/USER/Desktop/madziwa/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/USER/Desktop/madziwa","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/USER/Desktop/madziwa/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/USER/Desktop/madziwa/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/USER/Desktop/madziwa/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/USER/Desktop/madziwa/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {},
  "databaseUrl": "mysql://root:@localhost:3306/madziwa"
};
const envOptions = {
  prefix: "NITRO_",
...
const _RJjMwXCYyE1eX5ajmyuwzMSM6Lp93tGediV62xFWwEE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/USER/Desktop/madziwa";
...
const _fFNrnkcLG9StL2TR2c2C4cY2DJ5pKD0KmUz2ZNMglg = (nitroApp) => {
...
const plugins = [
  _RJjMwXCYyE1eX5ajmyuwzMSM6Lp93tGediV62xFWwEE,
_fFNrnkcLG9StL2TR2c2C4cY2DJ5pKD0KmUz2ZNMglg
];
...
const _bcp_tN = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/USER/Desktop/madziwa/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/USER/Desktop/madziwa/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_AbMsvA = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_c9y83e = () => Promise.resolve().then(function () { return pdf_get$1; });
const _lazy_2zmbUq = () => Promise.resolve().then(function () { return exportZip_post$1; });
const _lazy_W3FSYU = () => Promise.resolve().then(function () { return index_get$5; });
const _lazy_HL41ak = () => Promise.resolve().then(function () { return index_post$5; });
const _lazy_OgguLT = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_lJCQ3b = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_3fgfhI = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_M6O7sP = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_2sr3n8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _bcp_tN, lazy: false, middleware: true, method: undefined },
  { route: '/api/assessments/:id', handler: _lazy_AbMsvA, lazy: true, middleware: false, method: "delete" },
  { route: '/api/assessments/:id/pdf', handler: _lazy_c9y83e, lazy: true, middleware: false, method: "get" },
  { route: '/api/assessments/export-zip', handler: _lazy_2zmbUq, lazy: true, middleware: false, method: "post" },
  { route: '/api/assessments', handler: _lazy_W3FSYU, lazy: true, middleware: false, method: "get" },
  { route: '/api/assessments', handler: _lazy_HL41ak, lazy: true, middleware: false, method: "post" },
  { route: '/api/students', handler: _lazy_OgguLT, lazy: true, middleware: false, method: "get" },
  { route: '/api/students', handler: _lazy_lJCQ3b, lazy: true, middleware: false, method: "post" },
  { route: '/api/supervisors', handler: _lazy_3fgfhI, lazy: true, middleware: false, method: "get" },
  { route: '/api/supervisors', handler: _lazy_M6O7sP, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_2sr3n8, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2sr3n8, lazy: true, middleware: false, method: undefined }
];
...
const _id__delete = defineEventHandler(async (event) => {
  try {
    ...
    const assessment = await prisma$8.assessment.findUnique({
    ...
    await prisma$8.assessment.delete({
      where: { id: parseInt(id) }
    });
    return {
...
const pdf_get = defineEventHandler(async (event) => {
  try {
    const id = getRouterParam(event, "id");
    const assessment = await prisma$7.assessment.findUnique({
      where: { id: parseInt(id) },
      include: {
        student: true,
        supervisor: true
...
function generateAssessmentHTML$1(assessment, totalMark) {
...
const exportZip_post = defineEventHandler(async (event) => {
  try {
    ...
    const assessments = await prisma$6.assessment.findMany({
      where: {
        id: {
    ...
    setHeader(event, "Content-Disposition", `attachment; filename="assessments-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.zip"`);
    return zipBuffer;
  } catch (error) {
...
function generateAssessmentHTML(assessment, totalMark) {
  const formatDate = (dateString) => {
    return new Date(dateString).toLocaleDateString("en-US", {
      year: "numeric",
      month: "long",
...
const exportZip_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: exportZip_post
}, Symbol.toStringTag, { value: 'Module' }));

const prisma$5 = new PrismaClient();
const index_get$4 = defineEventHandler(async (event) => {
  try {
    const assessments = await prisma$5.assessment.findMany({
      include: {
        student: true,
        supervisor: true
      },
...
const index_post$4 = defineEventHandler(async (event) => {
  try {
    ...
    const assessment = await prisma$4.assessment.create({
      data: {
        assessmentDate: new Date(body.assessmentDate || /* @__PURE__ */ new Date()),
...
const index_get$2 = defineEventHandler(async (event) => {
  try {
    const students = await prisma$3.student.findMany({
      orderBy: {
        createdAt: "desc"
      }
    });
...
const index_post$2 = defineEventHandler(async (event) => {
  try {
    ...
    const student = await prisma$2.student.create({
      data: {
...
const index_get = defineEventHandler(async (event) => {
  try {
    const supervisors = await prisma$1.supervisor.findMany({
      orderBy: {
        createdAt: "desc"
      }
    });
